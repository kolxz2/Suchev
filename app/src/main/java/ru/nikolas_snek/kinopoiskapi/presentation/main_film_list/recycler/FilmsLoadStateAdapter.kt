...
import ru.nikolas_snek.kinopoiskapi.databinding.ItemErrorBinding
import ru.nikolas_snek.kinopoiskapi.databinding.ItemProgressBinding
...
class FilmsLoadStateAdapter :
    ...
    class ErrorViewHolder internal constructor(
        ...
        override fun bind(loadState: LoadState) {
            ...
            binding.textErrorMessage.text = loadState.error.localizedMessage
        }
